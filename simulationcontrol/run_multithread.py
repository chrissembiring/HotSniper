...
def get_instance(benchmark, parallelism, input_set='small'):
    threads = {
        'parsec-blackscholes': [2, 3, 4],
        'parsec-bodytrack': [3, 4],
        'parsec-canneal': [2, 3, 4],
        'parsec-dedup': [4],
        'parsec-fluidanimate': [2, 3],
        'parsec-streamcluster': [2, 3, 4],
        'parsec-swaptions': [2, 3, 4],
        'parsec-x264': [1, 3, 4],
        'splash2-barnes': [1, 2, 3, 4],
        'splash2-cholesky': [1, 2, 3, 4],
        'splash2-fft': [1, 2, 0, 4],
...
def example():
    run(['4.0GHz', 'maxFreq', 'slowDVFS'], get_instance('parsec-blackscholes', 2, input_set='simsmall'))
